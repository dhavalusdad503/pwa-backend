...
export interface IVisitRepository {
  ...
  update(id: string, visitData: Partial<Visit>, transaction?: Transaction): Promise<Visit>;
  delete(id: string): Promise<boolean>;
  findAll(options?: any): Promise<Visit[]>;
  count(): Promise<number>;
}

class VisitRepository extends BaseRepository<Visit> implements IVisitRepository {
  constructor() {
    super(Visit);
  }
